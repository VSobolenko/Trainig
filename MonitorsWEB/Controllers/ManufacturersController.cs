...
namespace MonitorsWEB.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ManufacturersController(MonitorsWEBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("idManufacturer,Brend")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idManufacturer,Brend")] Manufacturer manufacturer)
        {
        ...
        {
            return _context.Manufacturer.Any(e => e.idManufacturer == id);
        }
    }
}
